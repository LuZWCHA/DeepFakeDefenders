...
def train():
    ...
    # classification_module = VideoClassificationLightningModule.load_from_checkpoint("/nasdata2/private/zwlu/classify/Kaggle/deepfake_adv/logs/AV_ViTB/version_80/checkpoints/epoch=0-step=1260.ckpt")
...
def test(tta=False):
    ...
    # trainer.test(classification_module, data_module, ckpt_path="logs/AV_ViTB/version_108/checkpoints/epoch=4-step=22688.ckpt")
    # best tta 0.7223
    # trainer.test(classification_module, data_module, ckpt_path="logs/AV_ViTB/version_108/checkpoints/epoch=3-step=20166.ckpt")
    trainer.test(classification_module, data_module, ckpt_path="logs/AV_ViTB/version_108/checkpoints/epoch=3-step=20166.ckpt")
